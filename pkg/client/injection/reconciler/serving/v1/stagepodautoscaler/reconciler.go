...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1.StagePodAutoscaler, desiredFinalizers sets.Set[string]) (*v1.StagePodAutoscaler, error) {
	// Don't modify the informers copy.
