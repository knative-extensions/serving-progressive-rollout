...
import (
	...
	samplesv1alpha1 "knative.dev/serving-progressive-rollout/pkg/client/listers/samples/v1alpha1"
)
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.AddressableService, desired *v1alpha1.AddressableService) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AddressableService, desiredFinalizers sets.String) (*v1alpha1.AddressableService, error) {
	// Don't modify the informers copy.
