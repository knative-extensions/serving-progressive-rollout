...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.SimpleDeployment, desired *v1alpha1.SimpleDeployment) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.SimpleDeployment, desiredFinalizers sets.String) (*v1alpha1.SimpleDeployment, error) {
	// Don't modify the informers copy.
