...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1.RolloutOrchestrator, desiredFinalizers sets.String) (*v1.RolloutOrchestrator, error) {
	// Don't modify the informers copy.
