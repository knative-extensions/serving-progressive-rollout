...
func Get(ctx context.Context, selector string) v1alpha1.SimpleDeploymentInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch knative.dev/serving-progressive-rollout/pkg/client/informers/externalversions/samples/v1alpha1.SimpleDeploymentInformer with selector %s from context.", selector)
	}
