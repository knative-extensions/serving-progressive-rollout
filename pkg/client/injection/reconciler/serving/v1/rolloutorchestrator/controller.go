...
const (
	defaultControllerAgentName = "rolloutorchestrator-controller"
	defaultFinalizerName       = "rolloutorchestrators.serving.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	rolloutorchestratorInformer := rolloutorchestrator.Get(ctx)

	lister := rolloutorchestratorInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "serving.knative.dev.RolloutOrchestrator"),
	)
